...
var API={
	group:{cdnCache: cdnCache, method:'GET', base:'/api/group/page', param:{group_id:1}},
	page:{cdnCache: cdnCache,method:'GET', base:'/api/page/content', param:{page_id:1, pages:1, blocks:1}},
...
Router.prototype.get = function(callback,onerror){
	...
	var str = '';
	for (var n in this.api.param) {
		str += '_' + this.api.param[n];
	}
	//var apibase = 'http://192.168.0.249:8000';
	var apibase = 'http://m.imread.com/s';
	if (this.api.cdnCache) {
		//console.log(apibase + this.api.base + str)
		getJSON(this.api.m, apibase + this.api.base + str, {}, callback, onerror);	
	} else {
