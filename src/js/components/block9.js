						...
						<div className="swipe" ref="swipe" style={{'visibility': visibility, height: "100%"}}>
							<div className="swipe-wrap">
			                {
			                	this.props.data.contentlist.map(function(v, i) {
			                		...
			                		return (
			                			<Link style={{backgroundImage: 'url(http://m.imread.com/src/img/back/ad_default_back.jpg)',height: "100%",backgroundSize: "cover"}} to={hrefObj.url+search} target={hrefObj.target} className="swipe-ad f-fl" key={i} onClick={this.handleIntercurClick} data-intercut_id={v.content_id}>
